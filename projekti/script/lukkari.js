...
firebase.auth().onAuthStateChanged(function(user) {
  if (user) {
    ...
    document.getElementById("luokan_lukkari").style.display = "block";
    document.getElementById("sisaan_paasy").style.display = "none";
    ...
    if(user != null){
      ...
      document.getElementById("kayttaja").innerHTML = " Email: " + email_id;
    ...
    document.getElementById("luokan_lukkari").style.display = "none";
    document.getElementById("sisaan_paasy").style.display = "block";
